...
|<!--r7 c1-->f06|<!--r7 c2-->ClipMD                  |<!--r7 c3-->Copy Markdown bằng cách chọn element trên trang |<!--r7 c4-->`background_clipmd.js`, `clipmd_offscreen.js`, `clipmd_offscreen.html`, `turndown.js`, `content.js` |<!--r7 c5-->`startClipmdMarkdownPicker()`, `startClipmdPickMode()` | **Alt + Q** |<!--r7 c7-->🧪 Alpha |
