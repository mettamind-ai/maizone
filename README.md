...
- Opera: nếu alarms bị throttle, Mai dùng content script tick (wakeup SW bằng message) để badge vẫn chạy từng giây khi bạn đang ở một tab `http/https` (đổi tab/ẩn tab thì có thể chậm lại).
